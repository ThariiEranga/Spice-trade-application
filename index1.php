...
$result_products_count = mysqli_query($connect, $sql_products_count);

$total_products = 0;
if ($result_products_count && mysqli_num_rows($result_products_count) == 1) {
    $row_products_count = mysqli_fetch_assoc($result_products_count);
    $total_products = $row_products_count['total_products'];
} else {
    echo "Failed to fetch products count.";
}
